...
class TextQrCodeActivity  : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            GenerateTextQrCodeScreen(context = this)
        }
    }
}

@Composable
fun GenerateTextQrCodeScreen(context: Context) {
            ...
            Button(
                onClick = {
                    if (text.isNotEmpty()) {
                        ...
                        qrCodeBitmap = generateQRCodeBitmap(context, text)
